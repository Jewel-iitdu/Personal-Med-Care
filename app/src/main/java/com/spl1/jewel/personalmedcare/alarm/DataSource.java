...
public class DataSource {
    private static String TAG = "PersonalMedCare";
    ...
    private static long MAGIC_NUMBER = 0x54617261646f7641L;

    public static synchronized DataSource getInstance(Context context, String username) {

        mContext = context.getApplicationContext();
        DATA_FILE_NAME = username + ".txt";
        load();
        return mDataSource;
    }
